...
def retell_webhook():
    ...
    try:
        ...
        if function_name == 'search_restaurants':
            ...
            response = {
                'response': f"I received an unknown function: {function_name}. I can help you search for restaurants, get details about specific restaurants, or make reservation calls for you. What would you like to know?"
            }
